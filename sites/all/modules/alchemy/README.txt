...
- Download the Alchemy PHP SDK archive from http://www.alchemyapi.com/developers/sdks/ and install the files in the archive inside the module subdirectory alchemy/AlchemyAPI, or inside sites/all/libraries/AlchemyAPI
