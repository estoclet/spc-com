...
<div id="<?php echo $element["#id"]; ?>" class="slider-widget-container">
    <div style="float:left">
        <div id='<?php echo $element["#id"]; ?>_slider'
             class='ui-slider-1'></div>
    </div>
    <span style="margin-left: 15px;"><?php if (isset($element["#slider_suffix"])) {
        echo $element["#slider_suffix"];
      } ?>
        <span id='<?php echo $element["#id"]; ?>_nr_0'><?php echo $element["#default"][0] . $element["#value_suffix"]; ?></span> - <span
...
<?php if (isset($element["#description"])) : ?>
    <div class="description"
         style="margin-bottom:10px;"><?php echo $element["#description"]; ?></div>
<?php endif; ?>
<input type="hidden" name='<?php echo $element["#name"]; ?>[]'
       id='<?php echo $element["#id"]; ?>_value_0'
       value='<?php echo $element["#default"][0]; ?>'/>
<input type="hidden" name='<?php echo $element["#name"]; ?>[]'
       id='<?php echo $element["#id"]; ?>_value_1'
